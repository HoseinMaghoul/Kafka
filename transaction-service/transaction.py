...
if __name__ == "__main__":
    logging.INFO("Started Processed transaction ....")
    while True:
        ...
        logging.info(f"Successfull transactions sent... {data}")
        # send message to processed order topic 
        producer.send(ORDER_PROCESSED_KAFKA_TOPIC, json.dump(data).encode("utf-8"))
